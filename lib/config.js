...
export const CATEGORY_ICONS = {
  ...
  'Pressure Washing': '💦', 'Auto Repair': '🚗', 'Dental': '🦷',
  'Med Spa': '💆', 'Pools': '🏊', 'Garage Doors': '🚪',
  'Restaurants': '🍽️', 'Seafood': '🦐', 'BBQ': '🍖', 'Pizza': '🍕',
  'Bars & Breweries': '🍺'
};

export const icon = (c) => CATEGORY_ICONS[c] || '📍';

export const CATEGORIES = [
  // Services
  'Roofing', 'HVAC', 'Plumbing', 'Electrical', 'Landscaping',
  'Pest Control', 'Cleaning', 'Pressure Washing', 'Auto Repair',
  'Dental', 'Med Spa', 'Pools', 'Garage Doors',
  // Food and drink. Restaurants stays as the catch-all: a burger joint,
  // a taqueria or a bakery is none of the four below, and every listing
  // needs somewhere to sit.
  'Restaurants', 'Seafood', 'BBQ', 'Pizza', 'Bars & Breweries'
];
